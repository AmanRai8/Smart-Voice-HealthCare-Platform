      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative p-4 sm:p-6 md:p-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-2 h-2 bg-primary rounded-full shrink-0"></div>
              <span className="text-xs sm:text-sm">Professional health guidance</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="w-2 h-2 bg-primary rounded-full shrink-0"></div>
          ...
          <Link
            ...
            className={buttonVariants({
              variant: "default",
              className:
                "w-full mt-4 sm:mt-6 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-semibold py-2.5 sm:py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base",
            })}
          >
